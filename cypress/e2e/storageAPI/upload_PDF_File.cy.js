...
import { pdfUpload, blobFileCheck, deleteBlobFile } from '../../support/api.js'

describe('Storage API Test', () => {
  context ('PDF File Upload',() => {

    it('Upload PDF File with overwrite, check and delete file in blob', () => {
      const fileName = 'PDF-Test-108KB.pdf'; //  IFC file in cypress/fixtures
      ...
      .then((blob) => {
        ...
        formData.append('overwrite', 'true' );
          ...
          pdfUpload(formData).then((response) => {
